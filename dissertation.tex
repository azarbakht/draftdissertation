...
\begin{figure}[!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_1.pdf, width=1\columnwidth}
\epsfig{file=PLOTS_PDF/O_2.pdf, width=1\columnwidth}
\epsfig{file=PLOTS_PDF/O_3.pdf, width=0.5\columnwidth}
...
\begin{figure}[!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_5.pdf, width=0.6\columnwidth}
\epsfig{file=PLOTS_PDF/O_6.pdf, width=0.6\columnwidth}
\epsfig{file=PLOTS_PDF/O_7.pdf, width=0.6\columnwidth}
\epsfig{file=PLOTS_PDF/O_9.pdf, width=0.6\columnwidth}
...
\subsection{Time series analysis of communication sentiments}
Here’s my data:
