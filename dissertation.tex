...
\begin{tabular}{p{0.45\textwidth} p{0.40\textwidth} p{0.135\textwidth}}
\hline\noalign{\smallskip}
...
%rdesktop \& FreeRDP  & Non-conflict-driven & 2010 \\ \hline
...
%rdesktop \& FreeRDP  & 266 & 2010 \\ \hline
...
\begin{figure}[!htbp]
\epsfig{file=PLOTS_PDF/TS_1.pdf, width=0.5\columnwidth}
\epsfig{file=PLOTS_PDF/TS_2.pdf, width=0.5\columnwidth}
\epsfig{file=PLOTS_PDF/TS_3.pdf, width=0.5\columnwidth}
\epsfig{file=PLOTS_PDF/TS_4.pdf, width=0.5\columnwidth}
\epsfig{file=PLOTS_PDF/TS_5.pdf, width=0.5\columnwidth}
\epsfig{file=PLOTS_PDF/TS_6.pdf, width=0.5\columnwidth}
...
\begin{figure}[!htbp]
\epsfig{file=PLOTS_PDF/TS_7.pdf, width=0.5\columnwidth}
%\epsfig{file=PLOTS_PDF/TS_8.pdf, width=0.55\columnwidth}
\epsfig{file=PLOTS_PDF/TS_9.pdf, width=0.5\columnwidth}
\epsfig{file=PLOTS_PDF/TS_10.pdf, width=0.5\columnwidth}
\epsfig{file=PLOTS_PDF/TS_11.pdf, width=0.5\columnwidth}
\epsfig{file=PLOTS_PDF/TS_12.pdf, width=0.5\columnwidth}
...
\begin{figure}[!htbp]
\epsfig{file=PLOTS_PDF/D_1.pdf, width=0.5\columnwidth}
\hspace{6ex}
\vspace{6ex}
\epsfig{file=PLOTS_PDF/D_2.pdf, width=0.5\columnwidth}
\vspace{6ex}
\epsfig{file=PLOTS_PDF/D_3.pdf, width=0.5\columnwidth}
\hspace{6ex}
\epsfig{file=PLOTS_PDF/D_4.pdf, width=0.5\columnwidth}
...
\begin{figure}[!htbp]
\epsfig{file=PLOTS_PDF/D_5.pdf, width=0.5\columnwidth}
\hspace{6ex}
\vspace{6ex}
\epsfig{file=PLOTS_PDF/D_6.pdf, width=0.5\columnwidth}
\vspace{6ex}
\epsfig{file=PLOTS_PDF/D_7.pdf, width=0.5\columnwidth}
\hspace{6ex}
%\epsfig{file=PLOTS_PDF/D_8.pdf, width=0.57\columnwidth}
\epsfig{file=PLOTS_PDF/D_9.pdf, width=0.5\columnwidth}
\vspace{4ex}
...
\begin{figure}[!htbp]
\epsfig{file=PLOTS_PDF/D_10.pdf, width=0.5\columnwidth}
\hspace{6ex}
\vspace{6ex}
\epsfig{file=PLOTS_PDF/D_11.pdf, width=0.5\columnwidth}
\vspace{6ex}
\epsfig{file=PLOTS_PDF/D_12.pdf, width=0.5\columnwidth}
\hspace{6ex}
...
\begin{figure} [!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_1.pdf, width=0.7\columnwidth}
...
\begin{figure} [!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_2.pdf, width=0.7\columnwidth}
...
\begin{figure} [!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_3.pdf, width=0.7\columnwidth}
...
\begin{figure} [!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_5.pdf, width=0.7\columnwidth}
...
\begin{figure} [!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_6.pdf, width=0.7\columnwidth}
...
\begin{figure} [!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_7.pdf, width=0.7\columnwidth}
...
\begin{figure} [!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_9.pdf, width=0.7\columnwidth}
...
\begin{figure}
\centering
\epsfig{file=PLOTS_PDF/O_10.pdf, width=0.7\columnwidth}
...
\begin{figure}[!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_11.pdf, width=0.7\columnwidth}
...
\begin{figure} [!htbp]
\centering
\epsfig{file=PLOTS_PDF/O_12.pdf, width=0.7\columnwidth}
\caption{Time series with outliers detected for project GlusterFS (Not forked).}
\label{figureOutliers_12}
\end{figure}


%Anomalies detected in the time series of sentiments for project OpenStack Neutron: \\
%\input{R_Environment_Variables/outlier_table_project_11.tex}\\
%
%Anomalies detected in the time series of sentiments for project GlusterFS: \\
%\input{R_Environment_Variables/outlier_table_project_12.tex}\\

No anomalies were found in the time series of sentiments for project Apache CouchDB (Non-Conflict-Driven). \\

%\input{R_Environment_Variables/outlier_table_project_4.tex}\\
...
%\noalign{\smallskip}\hline\noalign{\smallskip}
%conflict-driven \& socially-related forking & conflict-driven \\ \hline
%Other socially-related forking & non-conflict-driven \\\hline
...
Appendix \ref{sectionInitialStudy} Figures \ref{figureNodesEdgesTimeR} and \ref{figureDiameterTimeR} are good examples of the expressiveness and limitations of a network-specific approach. Appendix \ref{sectionInitialStudy} Figure \ref{figureNodesEdgesTimeR} shows the normalized change in the number of active nodes (developers) and edges (interaction between developers) for eight FOSS projects from conflict-driven and non-conflict-driven categories. 

The normalized number of nodes and edges for the conflict-driven forks (i.e., second and third row) show a sudden sharp decrease around the month of fork. This can be because of dissolution of the development team, who either left the project, or stopped being active contributors as much as before. Appendix \ref{sectionInitialStudy} Figure \ref{figureDiameterTimeR} shows normalized change of diameter over time for the same projects. It is hard to make sense of normalized diameter changes across projects, and this demonstrates the limitations of network-specific approaches, as they may, or may not (often the case), help us understand the network dynamics.

As an example of expressiveness, Appendix \ref{sectionInitialStudy} Figure \ref{figureNodesEdgesTimeR} shows that a measurements-only approach shows us the trends of change or no-change in the measured metrics. It also shows one limitation of such an approach: even though we can see trend changes, it is hard to make sense of such trends given the short scope of the measurements. Additionally, it is hard to constitutes a reference point and back it up mathematically or statistically.
...
%
%We may explain the increase of decrease in preferential attachment in conflict-driven projects, as a result of software developers signaling others in the community of their status, by helping others in need (i.e., peripheral community members), which in turn brings them social prestige.
...
%\hline\noalign{\smallskip}
%%\textbf{Model parameter} & \textbf{conflict-driven Pers. Dif.} & \textbf{conflict-driven More Comm.} & \textbf{non-conflict-driven Tech. Dif.} & \textbf{No.F.}\\
%\textbf{Model parameter} & \textbf{conflict-driven Pers. Dif.} & \textbf{conflict-driven More Comm.} & \textbf{non-conflict-driven Tech. Dif.} & \\
%
%\noalign{\smallskip}\hline\noalign{\smallskip}
%Reciprocity  & * &  & * &  \\ \hline
...
%
%\subsection{} \textbf{Balance theory} \cite{Heider} talks about a motivation of individuals to move toward psychological balance. Balance theory considers cognitive consistency as a motive that drives sentiment or liking relationships, as well as liking of things created by or associated with the alter in the relationship.
%
...
%
%For ``personal differences'' forks conflict-driven, we expect to see a decrease in reciprocity, a decrease in 3-cycles indicating an increase in hierarchy, an increase in betweenness, which highlights the brokerage position of emergent fork leaders, and an increase in diameter, when broker positions are emptied, and hence, the distance between pairs of developers in the network increases. 
%
%For ``more community-driven development'' forks conflict-driven, we expect to see a decrease in 3-cycles, which indicates a stronger hierarchical structure,in addition to increase in positive assortativity, which highlights preference for homophile interactions.
%
%For  ``technical differences'' forks non-conflict-driven, we expect to see a decrease in betweenness, as developers temporarily leave the main project to work on new features, and this, we suppose, is done by some central figures, whose absence at the center, will distance pairs of developers in the network.
%
...
The tables \ref{ans1}-\ref{ans12} shows the results of the social network analysis longitudinal modeling of the projects. The rate parameter models how frequently the developers make mini-steps. The effects and their estimates that were found to be statistically significant are marked with asterisks, with their standard deviations and t statistics. 

We describe what the findings mean and how to interpret the findings in section \ref{Discussion}.
\pagebreak

\onehalfspacing

\captionof{table}{Estimates parameters in the model for Project Kamailio (Conflict-Driven). The outdegree density, transitive triplets, out-out-degree assortativity, and developers' seniority effects are statistically significant. The interpretations are discussed in section \ref{Discussion}.}   % Table based on sienaFit object ans
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project ffmpeg (Conflict-Driven). The outdegree density, transitive triplets, reciprocity, 3-cycles and out-out-degree assortativity are statistically significant. The interpretations are discussed in section \ref{Discussion}.}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project Amarok (Non-Conflict-Driven). The outdegree density, transitive triplets, and developers' source code activity effects are statistically significant. The interpretations are discussed in section \ref{Discussion}.}
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project Apache CouchDB (Non-Conflict-Driven). The outdegree density, transitive triplets, and developers' source code activity effects are statistically significant. The interpretations are discussed in section \ref{Discussion}.}
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project Pidgin (Non-Conflict-Driven). The outdegree density, transitive triplets, and developers' source code activity effects are statistically significant. The interpretations are discussed in section \ref{Discussion}.}
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project MPlayer (Non-Conflict-Driven). The outdegree density, transitive triplets, and developers' source code activity effects are statistically significant. The interpretations are discussed in section \ref{Discussion}.}
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project freeglut (Non-Conflict-Driven). The outdegree density, transitive triplets effects are statistically significant. The interpretations are discussed in section \ref{Discussion}.}
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project Ceph (Not forked). The outdegree density, reciprocity, transitive triplets, 3-cycles, out-out degree assortativity and developers' alter source code activity effects are statistically significant. The interpretations are discussed in section \ref{Discussion}.}
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project OpenStack Neutron (Not forked). The outdegree density, reciprocity, transitive triplets, 3-cycles, out-out degree assortativity and developers' seniority effects are statistically significant. The interpretations are discussed in section \ref{Discussion}.}
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project GlusterFS (Not forked). The outdegree density, transitive triplets, out-out degree assortativity and developers' alter seniority effects are statistically significant. The interpretations are discussed in section \ref{Discussion}.}
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
We analyzed both the contents and the relationship representations of the developers in forked open source software projects, that had gone through various types of forking. Contents of the developer communication messages were analyzed using time series analysis and sentiment analysis (Section \ref{TS_method}), and the interaction patterns were analyzed using social network analysis methods for longitudinal change (Section \ref{socialNetworkAnalysisMethodology}). \\
...
Our findings show that the conflict-driven forks experienced a period of pre-fork negativity, manifested in the developers' communication sentiments, as shown in Tables \ref{AnomaliesKamailio}-\ref{Anomalies2}. Our anomaly detection algorithms detected these anomalies. In contrast, the non-conflict-driven forks did not exhibit any anomalies, or showed periods of positive spikes (Figures \ref{figureOutliers_3}-\ref{figureOutliers_9}), which is indicative of positive communication sentiments. \\

Our findings also show that in conflict-driven forks, the combination of negative three-cycles and  positive transitive triplets were statistically significant, as shown in Tables \ref{ans1}-\ref{ans2}. According to Snijders et al. \cite{Snijders2010}, this combination is the indicator of the tendency for local hierarchies. So, in conflict-driven forks the social graph tended to have local hierarchies, which was manifested as statistically significant negative three-cycles effects combined with statistically significant positive transitive triplets effects (Table \ref{summaryConflictVsNonConflict}). This indicated several local hierarchies within the project community, which depending on the context, can be an indicator of several factions. \\ 

Our findings also show that conflict-driven forks had communities where there existed a tendency for heavy mailing-list poster developers to be interacting with to other heavy mailing-list poster developers, which was manifested as a statistically significant out-out degree assortativity effect. In contrast, non-conflict-driven forks has communities where there existed a tendency for heavy code contributors to be interacting with other heavy code contributors, as shown in Tables \ref{ans3}-\ref{ans9}, which was manifested as a statistically significant developer source code activity effect. This can be interpreted as a unhealthy vs. healthy dynamic, whereas, in the non-conflict-driven forked projects more code contributions translated into more conversations, so, the communication was backed by solid code. Whereas, in conflict-driven forked projects, the could have been much talk and not much code. One cannot help but think of Linus Torvald's quote \textit{``Talk is cheap. Show me the code.''}\\
...
%\appendix
%%Appendix A
%\section*{Appendix A: Table of all conflict-driven projects}
