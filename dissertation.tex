...
\noalign{\smallskip}\hline\noalign{\smallskip}
Kamailio \& OpenSIPS & 5450  & 2008 \\ \hline
ffmpeg \& libav &  20690 & 2011 \\ \hline
Amarok \& Clementine Player & 1642  & 2010 \\ \hline
Apache CouchDB \& BigCouch &  3746  & 2010 \\ \hline
Pidgin \& Carrier &  4095  & 2008 \\ \hline
MPlayer \& MPlayerXP &   6305  & 2005 \\ \hline
Asterisk \& Callweaver & 28012  & 2007 \\ \hline
%rdesktop \& FreeRDP  & 266 & 2010 \\ \hline
freeglut \& OpenGLUT & 2267  & 2004 \\ \hline
Ceph  &  7232  & NA \\ \hline
OpenStack Neutron &  20153   & NA \\ \hline
GlusterFS &   1245  & NA \\ 
\noalign{\smallskip}\hline
\end{tabular}
\end{table}
...
\begin{figure}[!htbp]
\epsfig{file=PLOTS_PDF/TS_1.pdf, width=0.55\columnwidth}
\epsfig{file=PLOTS_PDF/TS_2.pdf, width=0.55\columnwidth}
\epsfig{file=PLOTS_PDF/TS_3.pdf, width=0.55\columnwidth}
\epsfig{file=PLOTS_PDF/TS_4.pdf, width=0.55\columnwidth}
\epsfig{file=PLOTS_PDF/TS_5.pdf, width=0.55\columnwidth}
\epsfig{file=PLOTS_PDF/TS_6.pdf, width=0.55\columnwidth}
...
\begin{figure}[!htbp]
\epsfig{file=PLOTS_PDF/TS_7.pdf, width=0.55\columnwidth}
%\epsfig{file=PLOTS_PDF/TS_8.pdf, width=0.55\columnwidth}
\epsfig{file=PLOTS_PDF/TS_9.pdf, width=0.55\columnwidth}
\epsfig{file=PLOTS_PDF/TS_10.pdf, width=0.55\columnwidth}
\epsfig{file=PLOTS_PDF/TS_11.pdf, width=0.55\columnwidth}
\epsfig{file=PLOTS_PDF/TS_12.pdf, width=0.55\columnwidth}
\caption{Time Series of sentiments in developers' messages for projects (From top to bottom, left to right) Asterisk, freeglut, Ceph, OpenStack Neutron, and GlusterFS}
...
\begin{figure}[!htbp]
\epsfig{file=PLOTS_PDF/D_1.pdf, width=0.57\columnwidth}
\epsfig{file=PLOTS_PDF/D_2.pdf, width=0.57\columnwidth}
\epsfig{file=PLOTS_PDF/D_3.pdf, width=0.57\columnwidth}
\epsfig{file=PLOTS_PDF/D_4.pdf, width=0.57\columnwidth}
...
\begin{figure}[!htbp]
\epsfig{file=PLOTS_PDF/D_5.pdf, width=0.57\columnwidth}
\epsfig{file=PLOTS_PDF/D_6.pdf, width=0.57\columnwidth}
\epsfig{file=PLOTS_PDF/D_7.pdf, width=0.57\columnwidth}
%\epsfig{file=PLOTS_PDF/D_8.pdf, width=0.57\columnwidth}
\epsfig{file=PLOTS_PDF/D_9.pdf, width=0.57\columnwidth}
\caption{Time series decomposed into trend, seasonality and residual time Series for projects (From top to bottom, left to right) Pidgin, MPlayer, Asterisk, and freeglut.}
\label{figureDecpmposed_5to8}
\end{figure}

\begin{figure}[!htbp]
\epsfig{file=PLOTS_PDF/D_10.pdf, width=0.57\columnwidth}
\epsfig{file=PLOTS_PDF/D_11.pdf, width=0.57\columnwidth}
\epsfig{file=PLOTS_PDF/D_12.pdf, width=0.57\columnwidth}
\caption{Time series decomposed into trend, seasonality and residual time Series for projects (From top to bottom, left to right) Ceph, OpenStack Neutron, and GlusterFS}
...
\begin{table}
\centering
\caption{Anomalies detected in the time series of sentiments for project Kamailio. Note that all listed outliers are statistically significant with t-statistics greater than 1.96 in absolute value. ($sigma^2$ estimated as 128.8:  log likelihood = -1170.2,  aic = 2356.41)}
\label{TableDiversityMeasuresKunegisEtAl}
...
\begin{table}
\centering
\caption{Anomalies detected in the time series of sentiments for project ffmpeg. Note that all listed outliers are statistically significant with t-statistics greater than 1.96 in absolute value. ($sigma^2$ estimated as 57.33:  log likelihood = -1043.78,  aic = 2101.57)}
\begin{tabular}{rlrrrr}
  \hline
 & type & ind & coefhat & tstat & statistical significance (*)\\ 
  \hline
...
\begin{table}
\centering
\caption{Anomalies detected in the time series of sentiments for project Amarok. Note that all listed outliers are statistically significant with t-statistics greater than 1.96 in absolute value.($sigma^2$ estimated as 375.6:  log likelihood = -1326.61,  aic = 2661.22)}
\begin{tabular}{rlrrrr}
  \hline
 & type & ind & coefhat & tstat & statistical significance (*)\\ 
  \hline
...
\begin{table}
\centering
\caption{Anomalies detected in the time series of sentiments for project Pidgin. Note that all listed outliers are statistically significant with t-statistics greater than 1.96 in absolute value.($sigma^2$ estimated as 312.3:  log likelihood = -1307.25,  aic = 2622.49)}
\begin{tabular}{rlrrrr}
  \hline
 & type & ind & coefhat & tstat & statistical significance (*)\\ 
  \hline
...
\begin{table}
\centering
\caption{Anomalies detected in the time series of sentiments for project MPlayer. Note that all listed outliers are statistically significant with t-statistics greater than 1.96 in absolute value.($sigma^2$ estimated as 225.5:  log likelihood = -1251.94,  aic = 2517.88)}
\begin{tabular}{rlrrrr}
  \hline
 & type & ind & coefhat & tstat & statistical significance (*)\\ 
  \hline
...
\begin{table}
\centering
\caption{Anomalies detected in the time series of sentiments for project Asterisk. Note that all listed outliers are statistically significant with t-statistics greater than 1.96 in absolute value.($sigma^2$ estimated as 358.2:  log likelihood = -1227.85,  aic = 2463.7
  )}
\begin{tabular}{rlrrrr}
  \hline
 & type & ind & coefhat & tstat & statistical significance (*)\\ 
...
\begin{table}
\centering
\caption{Anomalies detected in the time series of sentiments for project freeglut. Note that all listed outliers are statistically significant with t-statistics greater than 1.96 in absolute value.($sigma^2$ estimated as 348.6:  log likelihood = -1307.6,  aic = 2619.2)}
\begin{tabular}{rlrrrr}
  \hline
 & type & ind & coefhat & tstat & statistical significance (*)\\ 
  \hline
...
%Anomalies detected in the time series of sentiments for project Ceph: \\
%\input{R_Environment_Variables/outlier_table_project_10.tex}\\
%
...
No anomalies were found in the time series of sentiments for project Apache CouchDB. \\
...
\captionof{table}{Estimates parameters in the model for Project Kamailio (Conflict-Driven)}   % Table based on sienaFit object ans
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project ffmpeg (Conflict-Driven)}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project Amarok (Non-Conflict-Driven)}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project Apache CouchDB (Non-Conflict-Driven)}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project Pidgin (Non-Conflict-Driven)}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project MPlayer (Non-Conflict-Driven)}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project freeglut (Non-Conflict-Driven)}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project Ceph (Not forked)}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project OpenStack Neutron (Not forked)}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
...
\pagebreak
\captionof{table}{Estimates parameters in the model for Project GlusterFS (Not forked)}   % Table based on sienaFit object ans
\begin{tabular}{l | r@{.}l r@{.}l r@{.}l | }
\hline
\rule{0pt}{2ex}\relax
Effect &\multicolumn{2}{c}{par.}&\multicolumn{2}{c | }{(s.e.)} &\multicolumn{2}{c}{$t$ stat.} \\[0.5ex]
